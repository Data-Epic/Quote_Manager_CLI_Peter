...
from quote_manager_cli_peter.cli import add, generate, import_quotes, list_quotes
...
@patch("quote_manager_cli_peter.cli.load_data")
@patch("quote_manager_cli_peter.cli.query_existing_data")
@patch("quote_manager_cli_peter.cli.get_db")
...
@patch("quote_manager_cli_peter.cli.get_db")
@patch("quote_manager_cli_peter.cli.random.choice")
...
@patch("quote_manager_cli_peter.cli.get_db")
@patch("quote_manager_cli_peter.cli.error_logger")
